...
public class BukuKontak { 
    ...
    // UPDATE NO 2: Memecah baris menjadi tiga bagian (nama, nomor, email)
    ...
    // TUGAS NO 1: Method cariKontak berdasarkan nama
    ...
    // TUGAS NO 3: Method hapusKontak berdasarkan nama + auto simpan ke berkas
    public void hapusKontak(String nama) {
        ...
        if (ditemukan) {
            simpanKeBerkas(); // Langsung simpan perubahan ke dalam file
        } else {
